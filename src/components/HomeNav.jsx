  ...
  return (
    <nav className="w-full flex justify-between items-center p-1 shadow-lg rounded-lg pb-8">
      ...
      <div className="flex-row flex gap-3 bg-[#0a0a3e] rounded-lg py-3 px-5">
        <Button
          className="flex-row flex gap-1 bg-[#0d0d51] p-2 rounded-lg"
        ...
        <Button
          className="flex-row flex gap-1 bg-[#0d0d51] p-2 rounded-lg ml-5"
      ...
      <div className="flex items-center gap-5">
        ...
        <Avatar className="rounded-full">
          <AvatarImage
            src="https://github.com/Aaditya-Salgaonkar.png"
            alt="User"
        ...
        <Button
          className="bg-red-600 hover:bg-red-700 px-4 py-2 text-white rounded-lg ml-5"
...
// This makes sure the user is logged out properly and the app resets after logout! Let me know if you want any changes! 🚀
